...
require_once(__DIR__ . '/ExtendedDateTime.php');

use Cartalyst\Sentry\Throttling\ThrottleInterface;
use Cartalyst\Sentry\Throttling\UserSuspendedException;
use Cartalyst\Sentry\Throttling\UserBannedException;

class Throttle extends \Cartalyst\Sentry\Paris\DateTimeModel implements ThrottleInterface
{

    const CLASS_NAME = 'Cartalyst\Sentry\Throttling\Paris\Throttle';

    public static $_table = 'throttle';
    ...
    {
        if (!is_object($this->last_attempt_at)) {
            return;
        }
    ...
    {
        if (!is_object($this->suspended_at)) {
            return;
        }
